...
class PitchCollection {
  ...
  /**
   * Generates a set of all unique Modes generated by calling matchMode on a Mode object and incrementing
   *    through all scale degrees in this
   * @param {Mode} Mode - a Mode object
   * @returns {Set<Mode>} - a set of new Mode objects that match the provided mode
   */
  matchAll(Mode) {
    // Not implemented
  }
  ...
  /**
   * Generates a set of all unique PitchCollection objects that are relative modes to this
   * @returns {Set<PitchCollection>} - a set of new PitchCollection objects
   */
  getAll() {
    // not implemented
  }
